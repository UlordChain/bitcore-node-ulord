...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitcore-node-ulord a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-ulord create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-ulord add wallet-service');
      console.log('    $ bitcore-node-ulord add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-ulord remove wallet-service');
      console.log('    $ bitcore-node-ulord remove insight-api');
      console.log();
    });
