...
/**
 * Will return the path and default bitcore-node-ulord configuration. It will search for the
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.ulord');
  var defaultConfigFile = path.resolve(defaultPath, './bitcore-node-ulord.json');
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            ...
            exec: path.resolve(__dirname, defaultPath, './data/ulordd')
          }
        }
      }
    };
